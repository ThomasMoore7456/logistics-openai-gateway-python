...
> Design notes for **logistics-openai-gateway-python** — a runnable python example that Model shipment events and proof-of-delivery decisions while routing OpenAI calls through a compatible gateway.
...
- **Feature code** — the actual task: shipment-exception-triage.
